...
__conda_setup="$('/Users/marinafranca/miniforge3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/marinafranca/miniforge3/etc/profile.d/conda.sh" ]; then
        . "/Users/marinafranca/miniforge3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/marinafranca/miniforge3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
# Added by Windsurf
export PATH="/Users/marinafranca/.codeium/windsurf/bin:$PATH"
. "/Users/marinafranca/.deno/env"#compdef deno
